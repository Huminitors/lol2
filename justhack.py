  ...
  time.sleep(20)
   ...
   def chalo1():
    ...
    while(y):
        ...
        print("Contact me on telegram @LOVE IS LIFE")

        print("Enter ",newperiod," Sapre:")
...
if(expirydate>today):
    ...
    if (False):
        ...
        (" Channel join krle bhosdke😁 @LOVE IS LIYE")
    ...
    print(" on telegram ----LOVE IS LIYE for activating")
